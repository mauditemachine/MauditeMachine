...
const StatsGate: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <form onSubmit={submit} className="max-w-xs mx-auto pt-[16vh] px-4">
      <label className="block font-body font-semibold text-white text-sm mb-2" htmlFor="stats-pass">
        Mot de passe stats
      </label>
      <input
        id="stats-pass"
